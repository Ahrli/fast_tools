...
SPOT_CANCEL_BATCH_ALGOS = '/api/spot/v3/cancel_batch_algos'
SPOT_ALGO='/api/spot/v3/algo'
...
FUTURE_CANCEL_BATCH_ALGOS = '/api/futures/v3/cancel_algos'
FUTURE_ALGO='/api/futures/v3/order_algo'
...
SWAP_CANCEL_BATCH_ALGOS = '/api/swap/v3/cancel_algos'
SWAP_ALGO='/api/swap/v3/order_algo'
